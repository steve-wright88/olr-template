...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    {{-- Benzing Banner --}}
    <div class="flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-xl px-5 py-3 mb-8">
        ...
        <p class="text-sm text-gray-600">All races timed using <strong class="text-gray-900">Benzing Live Electronic Timing</strong> with real-time results via <a href="https://oneloftrace.live" target="_blank" rel="noopener" class="font-semibold hover:underline" style="color: var(--accent);">oneloftrace.live</a></p>
    </div>
